...
from maksim_derkach.caclulator_Maksim_Derkach import Ui_Calculator
import sys
...
def action_factorial():
    text=ui.label_output.text()
    ui.label_output.setText(text+"factorial(")

def action_pi():
    text=ui.label_output.text()
    ui.label_output.setText(text+"3.14")

def action_log():
    text=ui.label_output.text()
    ui.label_output.setText(text+"log")
...
ui.pushButton_procent.clicked.connect(action_percent)
ui.pushButton_equals.clicked.connect(action_equals)
ui.pushButton_root.clicked.connect(action_square_root)
ui.pushButton_power.clicked.connect(action_root)
...
ui.pushButton_factorial.clicked.connect(action_factorial)
ui.pushButton_pi.clicked.connect(action_pi)
ui.pushButton_log.clicked.connect(action_log)
